...
// Items de navegación
const navItems = [
  { id: 'monitor', route: '/monitor', icon: '📍', label: 'Monitor Live' },
  { 
    id: 'fleet', 
    icon: '🚌', 
  ...
  { id: 'users', route: '/users', icon: '👥', label: 'Usuarios' },
  { id: 'analytics', route: '/analytics', icon: '📊', label: 'Analytics' },
  { id: 'alerts', route: '/alerts', icon: '🚨', label: 'Alertas' },
  { id: 'settings', route: '/settings', icon: '⚙️', label: 'Configuración' }
]
