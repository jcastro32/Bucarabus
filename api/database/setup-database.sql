-- =============================================
-- BucaraBUS - Configuración Inicial de Base de Datos
-- =============================================
...
SELECT 'CREATE DATABASE bucarabus_db OWNER bucarabus_user'
WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'bucarabus_db')\gexec
...
\echo '   Base de datos: bucarabus_db'
...
\echo ''
\echo '📝 Próximo paso:'
\echo '   psql -U bucarabus_user -d bucarabus_db -f deploy-all.sql'
\echo ''
